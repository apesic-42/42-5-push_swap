...
static t_listutil *pb_court(t_element *premier_a, t_element *premier_b, t_listutil *listutil)
{
...
static t_listutil *pa_court(t_element *premier_b, t_element *premier_a, t_listutil *listutil)
{
